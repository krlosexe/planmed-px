...
function Index(props) {
  ...
  const [NumberPhone, setNumberPhone] = useState("") //3992222222 //3991111111
  const [isSelected, setSelection] = useState(false);
  const [Terminos, setTerminos] = useState("#")
  const [acceptance_token, setacceptance_token] = useState(false)
  const userDetails = useContext(UserContext)
  const { setUserDetails } = useContext(UserContext)
console.log("here in nequi")
  ...
  function GotoPay() {
    ...
    let from = "PayToNequi"
    goToScreen2("PaymentSummary", from)
  }
        ...
        <View>
          <View style={styles.card}>
            ...
            <View style={styles.checkboxContainer}>
              ...
              />
              <Text style={styles.label}>Acepto haber leído los <OpenURLButton url={Terminos} ><Text style={{color:"blue",textDecorationLine: 'underline'}}>Términos y Condiciones y la Política de Privacidad</Text></OpenURLButton> para hacer esta compra.</Text>
            </View>
          </View>
...
<View style={{width:"100%", alignItems:"center", alignContent:"center"}}>
  ...
  onPress={() => {  goToScreen2("MethodPay", "PayToNequi") }}
  >
