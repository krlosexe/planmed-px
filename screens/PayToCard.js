...
import {
  StyleSheet, Alert, Text, Linking, Picker, View,
  TextInput, TouchableOpacity, StatusBar, Image, ScrollView, ActivityIndicator, ActionSheetIOS, Button
} from 'react-native';
...
import { primaryColor,colorTertiary,primaryColorOpacity } from '../Colors.js'
...
function Index(props) {
  ...
  function goToScreen2(screen,from) {
    navigation.navigate(screen, { randomCode: Math.random(),from })
  }
  ...
  if (requesting) {
    return (
      <View style={{
        ...
        {/* <ActivityIndicator size="large" color="#f27072" /> */}
        ...
        <View>
          ...
          <View style={styles.card}>
            ...
            <View style={styles.selects_row}>
              ...
              <View style={{ backgroundColor: "#eee", width: "24%", marginRight: 4, borderBottomWidth: 1, borderBottomColor: primaryColor }}>
                {
                  Platform.OS === "ios" &&
                ...
                {
                  Platform.OS === "ios" &&
                  <Text style={{ backgroundColor: "#f27072", color: "white", textAlign: "center" }}>Mes</Text>
                }
              ...
              <View style={{ backgroundColor: "#eee", width: "24%", marginRight: 4, borderBottomWidth: 1, borderBottomColor: primaryColor }}>
                ...
                {
                  Platform.OS === "ios" &&
                  <Text style={{ backgroundColor: "#f27072", color: "white", textAlign: "center" }}>Año</Text>
                }
              ...
              <View style={{ backgroundColor: "#eee", width: "41%", borderBottomWidth: 1, borderBottomColor: primaryColor}}>
                <TextInput
                  style={styles.inputText}
                  placeholder="CVC"
                  placeholderTextColor="#777"
          ...
          <TouchableOpacity style={[styles.loginBtn,{marginBottom: 100}]}
  onPress={() => {  goToScreen2("MethodPay", "PayToCard") }}
  >
